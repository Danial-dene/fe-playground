...
import styles from "./CommonTableView.module.scss";
import { Icon } from "./Icon";
import { AsyncTableProps } from "./AsyncTable";

interface CommonTableViewProps extends AsyncTableProps {
  tableTitle?: string;
...
const CommonTableView: React.FC<CommonTableViewProps> = forwardRef(
  (props, ref) => {
    const [form] = useForm();
    ...
    return (
      <div className={styles.CommonTableView}>
        {props.filterForm && (
          <Form
            name="filter-form"
            onFinish={onFinish}
...
CommonTableView.defaultProps = {
  filterDefaultActiveKey: ["1"],
};
CommonTableView.displayName = "CommonTableView";

export { CommonTableView };
